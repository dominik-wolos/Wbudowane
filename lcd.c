...
// draw rect A(0,0) B(100, 100) -> draw line 0,0-0,100; 0,0-100,0; 100,0-100,100; 0,100-100,100
LCDSetLine(x0,y0,x0,y1,color);//UP
LCDSetLine(x0+1,y0,x1-1,y0,color);//LEFH
LCDSetLine(x0+1,y1,x1-1,y1,color);//RIGHT
LCDSetLine(x1,y0,x1,y1,color);//DOWN
...
WriteSpiData(0);
WriteSpiData(131);
// set the display memory to bColor
WriteSpiCommand(RAMWR);
for(i = 0; i < ((131 * 131) / 2); i++) {
